...
class CommentController extends Controller
{
	public function __construct()
		...
		public function ajaxRequestGet()
		{
			...
			$conversation_count		= Notification::countConversation();
			$product_count			= Notification::countProduct();
			$registeration_count	= Notification::countRegistration();
			$order_count			= Notification::countOrder();

			$array = array(
				"conver_count"	=> $conversation_count,
				"product_count" => $product_count,
				"regis_count"	=> $registeration_count,
