              ...
              <div class="login-form signup-form">
                ...
                <form class="mregisterform" action="{{route('user-register-submit')}}" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="form-input">
                                <input type="text" class="User Name" id="new_phone" name="phone" placeholder="{{ $langg->lang184 }}" required="" />
                ...
                <div class="form-input">
                 ...
                 <div class="form-input">
                        ...
                        <div class="col-lg-12">
 							<div class="form-input">
                              <input type="checkbox" name="terms_and_condition" id="terms_and_condition_5" class="form-check-input">
                              <label class="form-check-label" for="terms_and_condition_5">I agree to the <a href="{{ url('terms') }}" target="_blank">Terms & Condition</a> and <a href="{{ url('Vendor Agreement') }}" target="_blank">Vendor Agreement</a></label>
                          </div>
                       	</div>
...
@section('scripts')
<script>
var phone_number = window.intlTelInput(document.querySelector("#new_phone"), {
