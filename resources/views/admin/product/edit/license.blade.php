...
@section('content')
					...
					<div class="col-lg-4">
					<div class="left-area">
					<h4 class="heading">{{ __("Reject Product Reason") }}* </h4>
					</div>
					</div>
					<div class="col-lg-7">
					<input type="text" class="input-field" placeholder="{{ __("Enter rejection reason") }}" name="reject">
					<input type="hidden" name="to" value="{{$data->user_id}}" />
					</div>
					</div>
					<div class="row">
					<div class="col-lg-4">
					...
					@endif
                                              ...
                                              @endforeach
												...
												<div class="row">
                                                   ...
                                                   <div class="row file {{ $data->file != null ? '':'hidden' }}">
													<div class="col-lg-4">
														<div class="left-area">
																<h4 class="heading">{{ __("Download File") }}</h4>
														</div>
													</div>
													<div class="col-lg-7">
														
														 <a href="{{asset('assets/files/'.$data->file)}}"  class="mybtn1" download>
                                            <i class="fas fa-eye"></i>  {{ __("Download") }}
						...
						<div class="row">
							...
							<div class="col-lg-7">
								<div class="img-upload">
									...
									<div id="image-preview" class="img-preview"  style="background: url({{ asset('assets/vendor/images/'.$data->photo) }}) no-repeat;">
						...
						<input type="file" name="gallery[]" class="hidden" id="uploadgallery" accept="image/*" multiple>
												...
												<!--div class="row">
													...
													<div class="col-lg-7">
														<input type="text" class="input-field" placeholder="Enter Product Code" name="product_code" value="{{ $data->product_code }}" required="">
													</div>
												</div-->
												<!--<div class="row">-->
												<!--	<div class="col-lg-4">-->
												...
												<!--	</div>-->
												<!--	<div class="col-lg-7">-->
												<!--		<input type="text" class="input-field" placeholder="Enter Number of Pages" name="pages" value="{{ $data->pages }}" required="">-->
												<!--	</div>-->
												<!--</div>-->
												<!--<div class="row">-->
												<!--	<div class="col-lg-4">-->
												...
												<!--	</div>-->
												<!--	<div class="col-lg-7">-->
												<!--		<input type="text" class="input-field" placeholder="Enter Number of Chapters" name="chapters" value="{{ $data->chapters }}" required="">-->
												<!--	</div>-->
												<!--</div>-->
												<!--<div class="row">-->
												<!--	<div class="col-lg-4">-->
												...
												<!--		  {{ 'Microsoft Word' == $data->file_format ? "selected":""}}>Microsoft Word</option>-->
												<!--		  <option value="Pdf" {{ 'Pdf' == $data->file_format ? "selected":""}}>Pdf</option>-->
												<!--		  <option value="PowerPoint" {{ 'PowerPoint' == $data->file_format ? "selected":""}}>PowerPoint</option>-->
												<!--		  <option value="Microsoft Excel" {{ 'Microsoft Excel' == $data->file_format ? "selected":""}}>Microsoft Excel</option>         <option value="Jpeg" {{ 'Jpeg' == $data->file_format ? "selected":""}}>Jpeg</option>  -->
