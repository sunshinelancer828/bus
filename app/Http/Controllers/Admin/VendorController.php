...
class VendorController extends Controller
{
    ...
    public function withdrawdatatables()
    {
         ...
         return Datatables::of($datas)
                            ...
                            ->addColumn('reference ', function(Withdraw $data) {
    ...
    public function accept($id)
    {
        ...
        $msg .= "Your withdrawal request of ".$curr->sign.$total_amount." has been released and ".$curr->sign.$amount." has been sent into your Account.<br><br>";        
    ...
    public function reject($id)
    {
        ...
        $account->current_balance = $withdraw->amount  + $account->current_balance;
        ...
        $msg = "Hello " . $account->shop_name . ",<br><br>";
        $msg .= "Your withdrawal request of ".$curr->sign.$total_amount." has been cancelled and ".$curr->sign.$total_amount." has been refunded back to your current balance.<br><br>";
        $msg .= "Thank you as we look forward for a mutual advantage.<br><br>";
        $msg .= "All at ProjectShelve<br> ";
        $msg .= "Call/WhatsApp: (+234) 08147801594<br>";
        $msg .= "E-mail: projectshelve@gmail.com<br>";
