                                    ...
                                    @foreach($cart->items as $product)
                                        <tr>
                                            ...
                                            @if($product['item']['user_id'] != 0)
                                                @php
                                                $newuser = App\Models\User::find($product['item']['user_id']);
                                                @endphp
                                            ...
                                            @if($product['item']['type'] != 'Physical')
                                                @if($order->payment_status == 'Completed')
                                                    ...
                                                    @endif
                                                    @if($product['license'] != '')
                                                        <a href="javascript:;" data-toggle="modal" data-target="#confirm-delete" class="btn btn-sm btn-info product-btn" id="license">
                                                            <i class="fa fa-eye"></i> {{ $langg->lang317 }}
                                                        </a>
                                                    @endif
                                                @endif
                                            @endif
