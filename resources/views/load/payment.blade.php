...
<div class="col-lg-6">
	...
	<input class="form-control" name="account_name" type="text" placeholder="Account Name"  required />
	<label>{{ $langg->lang167 }} (Optional)</label>
	<input class="form-control" name="txn_id4" type="text" placeholder="{{ $langg->lang167 }}"  />
	<label>Attach Screenshot (Optional)</label>
	<input type="file" name="screenshot" accept="image/x-png,image/gif,image/jpeg" />
