                            ...
                            <table class="table">
                                ...
                                @if($order->method == "Bank Payment" )
                                     ...
                                     <tr>
                                        ...
                                        <td width="10%">:</td>
                                        <td width="45%"> 
                                            <a href="{{asset('assets/order_screenshot/'.$order->screenshot)}}" target="_blank" download />
                                        ...
                                        @foreach($cart->items as $key => $product)
                                            <tr>
                                                ...
                                                <td>
                                                   ...
                                                   @if($product['color'])
                                                    <p>
                                                        <strong>{{ __('color') }} :</strong> <span style="width: 40px; height: 20px; display: block; background: #{{$product['color']}};"></span>
                                                    </p>
                                                    @endif
