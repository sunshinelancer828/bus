                        ...
                        <div class="content-area">
                         ...
                         <form id="geniusform" class="form-horizontal" action="{{route('vendor-wt-store')}}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-sm-12">
                                        <select class="form-control" name="methods" id="withmethod" required>
                                            ...
                                            <option value="Bank" selected>{{ $langg->lang486 }}</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-sm-12">
                                        <input name="bankname" placeholder="Bank Name" class="form-control"  type="text" value="" required>
                                    </div>
                                </div>
...
<script type="text/javascript">
    ...
    $("#withmethod").change(function(){
        ...
        if(method == "Bank"){
            ...
            $("#bank").find('input[name="address"]').attr('required',false);
            $("#bank").find('input[name="swift"]').attr('required',false);
