				...
				<div class="product-description">
                  ...
                  <div class="gocover" style="background: url({{asset('assets/images/'.$gs->admin_loader)}}) no-repeat scroll center center rgba(45, 45, 45, 0.5);"></div>
				   @if($data->rejected)
				    <div class="row">
						<div class="col-lg-12">
							<div class="left-area rejected" style="text-align:center">
									<h4 class="heading">Your product is rejected by Admin. Below are the reasons:</h4>
									<br>
									<p class="sub-heading1">{{ $data->rejected }}</p>
							</div>
						</div>
					</div>
					@endif
						...
						<div class="row">
							...
							<div class="col-lg-7">
								<select  name="file_format" required="">
									...
									<option value="Microsoft Word" {{ 'Microsoft Word' == $data->file_format ? "selected":""}}>Microsoft Word</option>
									...
									<option value="Microsoft Excel" {{ 'Microsoft Excel' == $data->file_format ? "selected":""}}>Microsoft Excel</option>         
									<option value="Jpeg" {{ 'Jpeg' == $data->file_format ? "selected":""}}>Jpeg</option>  
									<option value="MP4" {{ 'MP4' == $data->file_format ? "selected":""}}>MP4</option> 
								</select>
							</div>
						</div>
