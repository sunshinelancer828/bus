...
Route::prefix('admin')->group(function() {
  ...
  //Route::post('/products/reject/{id}', 'Admin\ProductController@reject')->name('admin-prod-reject');
  // EDIT SECTION ENDS
...
// Verification Section Ends
  ...
  //------------ ADMIN PRODUCT DISCUSSION SECTION ------------
    ...
    Route::get('/noteRequest', 'Admin\CommentController@ajaxRequestGet')->name('admin-ajax');
 ...
 //------------ ADMIN PRODUCT DISCUSSION SECTION ENDS ------------
  ...
  //Route::get('/messages/datatables', 'Admin\MessageController@datatables_messages')->name('admin-message-datatables1');
  ...
  Route::get('/messages', 'Admin\MessageController@messages')->name('admin-message-message');
...
// ************************************ FRONT SECTION **********************************************
  ...
  Route::get('/sitemap/','Front\CatalogController@categories')->name('front.sitemap');
