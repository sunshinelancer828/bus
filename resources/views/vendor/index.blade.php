                ...
                <div class="col-md-12 col-lg-6 col-xl-4">
                    <div class="mycard bg7">
                        <div class="left">
                            ...
                            <a href="{{route('vendor-prod-index')}}" class="link">Change</a>
                        </div>
                        <div class="right d-flex align-self-center">
                            <div class="icon">
                ...
                <div class="col-md-12 col-lg-6 col-xl-4">
                    <div class="mycard bg6">
                        <div class="left">
                            ...
                            <span class="number">{{ App\Models\Product::vendorConvertPrice( App\Models\VendorOrder::where('user_id','=',$user->id)->where('status','=','completed')->sum('total_price') ) }}</span>
                        </div>
                        <div class="right d-flex align-self-center">
                            <div class="icon">
