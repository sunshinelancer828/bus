                        ...
                        <div class="top-area">
                                <div class="content">
                                    ...
                                    @if($order->method == 'Bank Payment')
                                         Your Product will be sent to {{$order->customer_email}} and {{$order->customer_phone}} once payment is confirmed. Kindly quote Order Number for any complaint.<p class = 'text' style = 'color:red'> If Product is not delivered to your inbox , kindly check Promotion or Spam Folder.</p>
                                    @else
                                        @if($order->payment_status  == 'Completed')
                                              Your {{ implode(',', $category) }} has been sent to <strong>{{$order->customer_email}}</strong> and WhatsApp number<strong>{{$order->customer_phone}}</strong>.
                                             <br> 
                                             <span style="color: red">Kindly check your Spam Folder or Promotions if not found in your Inbox</span>
                                             <br>
                                             Quote below Order Number for any complaint
                                        @else
                                            {{ $langg->order_text }}
                                        @endif
                                    @endif
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-6">
                                                                    ...
                                                                    @if($order->method != "Cash On Delivery" && $order->method != "Wallet")
                                                                        ...
                                                                        {{$order->method}} {{ $langg->lang296 }} <p id="ttn">{{ isset($_GET['collection_id']) ? $_GET['collection_id'] : '' }}</p>
                                                                        @else
                                                                        {{$order->method}} {{ $langg->lang296 }} <p id="ttn">{{$order->txnid}}</p>
                                                                        @endif
