						...
						<div class="d-flex justify-content-between">
							...
							<div class="right-eliment">
								<ul class="list">
									...
									<li class="bell-area">
										<a id="notf_conv" class="dropdown-toggle-1 notf_conver" href="javascript:;">
			...
			$(document).ready(function () {
				...
				$.ajax({
					...
					success:function(data){
						cc ="<i class=\"far fa-envelope\"></i><span id=\"conv-notf-count\">"+ data.conver_count+"</span>";
						pc ="<i class=\"icofont-cart\"></i><span id=\"product-notf-count\">"+ data.product_count+"</span>";
						rc ="<i class=\"far fa-user\"></i></i><span id=\"user-notf-count\">"+ data.regis_count+"</span>";
						oc ="<i class=\"far fa-newspaper\"></i><span id=\"order-notf-count\">"+ data.order_count+"</span>";
						$(".notf_conver").html(cc);
						$("#notf_product").html(pc);
						$("#notf_user").html(rc);
						$("#notf_order").html(oc);
					}
				});
