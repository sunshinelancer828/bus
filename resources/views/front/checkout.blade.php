		...
		<div class="container">
			...
			<div class="row">
			  <div class="col-lg-8 order-last order-lg-first">
        		<form id="twocheckout" action="" method="POST" class="checkoutform" enctype="multipart/form-data">
							...
							<div class="tab-pane fade show active" id="pills-step1" role="tabpanel" aria-labelledby="pills-step1-tab">
								<div class="content-box">
									...
									<div class="content">
										...
										<p>Complete material is sent to the email address and WhatsApp number you provide here immediately after payment</p>
											<h5 class="title">
												{{ $langg->lang147 }}
											</h5>
											<div class="row">
                                        		...
                                        		<input type="hidden" name="state" value="{{ Auth::guard('web')->check() ? Auth::guard('web')->user()->state : '' }}" />
				...
				<div class="col-lg-4">
		            ...
		            <div class="total-price">
		              ...
		              <p>
						...
						<input type="hidden" id="totalp" value={{$totalPrice}}>
