...
<div class="account-info">
      ...
      <div class="row">
                                            ...
                                            <div class="col-lg-8">
                                                    <input type="tel" class="option valid_phone" name="phone" placeholder="{{ $langg->lang184 }}" required>
                                            </div>
                                        </div>
                                        <!--div class="row">
                                            <div class="col-lg-4">
                                        ...
                                        <!--div class="row">
										 ...
										 <div class="row">
                                            ...
                                            <div class="col-lg-8">
                                                    <input type="text" class="option" name="city" placeholder="{{ $langg->lang158 }}">
                                            </div>
                                        </div>
										<br>
										 ...
										 <div class="row">
                                            ...
                                            <div class="col-lg-8">
                                                    <input type="text" class="option" name="state" placeholder="State">
                                            </div>
                                        </div>
